...
1. Требование 1:
- Документы [format.md](docs/format.md), описывающий основные правила формата, [spath.md] (docs/spath.md), описывающий язык навигации SPath, а также [API.md](docs/API.md) с описанием API;
